public class ListaEncadeadaOrdenada<T> implements TADListaEncadeadaOrdenada<T> {
    ...
    public void insereOrdenado(T valor) {
        ...
        for (int i = 0; i < tamanho; i++) {
            Integer valorAtual = (Integer) auxiliar.getValor();

            if (valorAtual > (Integer) valor) {
                inserePosicao(valor, i);
                return;
            }
