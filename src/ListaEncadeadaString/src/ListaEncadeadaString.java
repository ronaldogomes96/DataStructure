public class ListaEncadeadaString<T> implements TADListaEncadeadaString<T> {
    ...
    public void removeNoComString(T caractere) {
        ...
        for(int i = 0; i <= tamanho; i++) {
            ...
            String palavra = (String) auxiliar.getValor();

            if(palavra.contains((CharSequence) caractere)){
                removePosicao(i);
            }
